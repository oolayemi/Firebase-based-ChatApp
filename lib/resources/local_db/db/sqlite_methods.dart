...
class SqliteMethods implements LogInterface {
  ...
  String isVideoCall = "is_video_call";
  ...
  _onCreate(Database db, int version) async {
    String createTableQuery =
        "CREATE TABLE $tableName ($id INTEGER PRIMARY KEY, $callerName TEXT, $callerPic TEXT, $receiverName TEXT, $receiverPic TEXT, $callStatus TEXT, $timestamp TEXT, $isVideoCall TEXT)";
